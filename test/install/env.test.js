...
describe('install_env', ()=>{
  ...
  it('no_settings', () => {
    ...
    expect(envs).to.have.property('LD_LIBRARY_PATH', '/code/.fun/root/usr/lib:/code/.fun/root/usr/lib/x86_64-linux-gnu:/code/.fun/root/lib/x86_64-linux-gnu:/code:/code/lib:/usr/local/lib');
  });
  ...
  it('with_LD_LIBRARY_PATH', () => {
    ...
    expect(envs).to.have.property('LD_LIBRARY_PATH', '/usr/lib:/code/.fun/root/usr/lib:/code/.fun/root/usr/lib/x86_64-linux-gnu:/code/.fun/root/lib/x86_64-linux-gnu:/code:/code/lib:/usr/local/lib');
  });
