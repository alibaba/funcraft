  ...
  await promiseRetry(async (retry, times) => {
    try {      
      ...
      if (ex.code && ex.code.startsWith('InvalidParameter')) {
        ...
        throw new Error(red(`You are not authorized to do this action.\nPlease configure AliyunRAMFullAccess permissions for sub-users or use the primary account ak`));
