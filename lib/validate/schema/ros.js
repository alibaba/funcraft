      ...
      'patternProperties': {
        '^[a-zA-Z_][a-zA-Z.0-9_-]{0,127}$': {
          'properties': {
            'Type': {
              'type': 'string',
              'enum': ['Aliyun::Serverless::Service', 'Aliyun::Serverless::TableStore', 'Aliyun::Serverless::Api', 'Aliyun::Serverless::Log', 'Aliyun::Serverless::CustomDomain', 'Aliyun::Serverless::MNSTopic', 'Aliyun::Serverless::Flow']
            }
          },
          'if': {
            'properties': {
