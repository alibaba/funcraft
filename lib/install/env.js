...
const resolveMountPoint = require('../nas').resolveMountPoint;
...
function addEnv(envVars, nasConfig) {
  ...
  if (nasConfig) {
    return addNasesEnv(envs, nasConfig);
  }
...
function addNasEnv(envs, prefix) {
