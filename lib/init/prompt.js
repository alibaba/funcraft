...
async function promptForSameFunction(sameFuncResArray) {

  const choicesFuntions = sameFuncResArray.map(obj => {
      
    return obj.serviceName + '/' + obj.functionName;
  });
...
module.exports = { promptForConfig, promptForExistingPath, promptForTemplate, promptForSameFunction };
