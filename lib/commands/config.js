...
const mark = require('../../lib/deploy/deploy-by-tpl');
...
async function config() {
  ...
  const markedAccessKeyId = mark.mark(profile.accessKeyId);
  const markedAccessKeySecret = mark.mark(profile.accessKeySecret);
