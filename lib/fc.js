...
const DEFAULT_LOGSTORE = 'default-logstore';
...
async function transformLogConfig(logConfig) {
  if (logConfig === 'Auto') {
    ...
    console.log(`\tproject: ${DEFAULT_PROJECT_NAME}, logstore: ${DEFAULT_LOGSTORE}\n`);

    await makeSlsAuto(DEFAULT_PROJECT_NAME, description, DEFAULT_LOGSTORE);
...
module.exports = {
  ...
  makeFcUtilsFunctionNasDirChecker, defaultLogConfig
};