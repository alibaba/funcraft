...
async function makeFunction(baseDir, {
  ...
  try {
    ...
    if (ex.message.indexOf('timeout') !== -1) {
      ...
      throw new Error('\ndeploy failed: may be caused by network timeout. you can try the following ways:\n1.increase the timeout by "fun config".\n2.add .funignore file ignores useless files or use webpack to tailor the package size and redeploy it.');
    }
    throw ex;
  }
