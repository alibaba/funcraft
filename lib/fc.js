...
async function transformLogConfig(logConfig) {
  ...
  if (logConfig === 'Auto') {
    project = 'default-log-project2';
    logstore = 'default-log-store2';
    ...
    console.log(`\tproject: ${project}, logstore: ${logstore}\n`);

    await makeSlsAuto(project, description, logstore);
  }
  return {
    project: project || logConfig.Project || '',
    logstore: logstore || logConfig.Logstore || ''
  };
}
