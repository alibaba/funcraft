...
function updateNasAutoConfigureInTpl(tplPath, tpl, nasServiceName) {
  ...
  console.log(yellow(`\nFun add 'NasConfig: Auto' configuration to your template.yml.`));
...
async function backupTemplateFile(tplPath) {
  ...
  console.log(yellow(`Fun automatically backups the original ${path.basename(tplPath)} file to ${newPath}\n`));
}
