...
async function readFileFromNasYml(baseDir) {
...
async function getNasMappingsFromNasYml(baseDir) {
...
async function extractNasMappingsFromNasYml(baseDir, serviceName) {
  ...
  const content = await getNasMappingsFromNasYml(baseDir);
...
async function mergeNasMappingsInNasYml(baseDir, serviceNasMappings) {
  // read from .nas.yml
  const nasMappingsInNasYml = await getNasMappingsFromNasYml(baseDir);
