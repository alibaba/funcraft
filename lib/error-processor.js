...
class RosStackValidationErrorProcessor extends ErrorProcessor {
  ...
  async process(message) {
    console.log(red('StackValidationFailed: template syntax mismatch with ROS support. You may be able to solve it by executing the command \'fun package -b ossBucketName\'.'));
  }
}
