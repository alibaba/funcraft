...
async function generateContainerBuildOpts(runtime, containerName, mounts, cmd, envs) {
  ...
  const imageName = resolveRuntimeToDockerImage(runtime, true);
...
module.exports = {
  ...
  isFromChinaMotherland, ALIYUN_REGISTRY, pathTransformationToVirtualBox, generateContainerBuildOpts
};