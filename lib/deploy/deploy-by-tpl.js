...
async function deployFunction(baseDir, serviceName, functionName, functionRes, nasConfig) {
...
async function deployFunctions(baseDir, serviceName, serviceRes) {
  ...
  for (const [k, v] of Object.entries(serviceRes)) {
    if ((v || {}).Type === 'Aliyun::Serverless::Function') {
      ...
      await deployFunction(baseDir, serviceName, k, v, serviceProps.NasConfig);
...
module.exports = { deploy, deployCustomDomain, deployService };