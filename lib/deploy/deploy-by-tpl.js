...
async function deployFunction(baseDir, serviceName, functionName, functionDefinition) {
  ...
  await deployTriggers(serviceName, functionName, functionDefinition.Events);
}

async function deployFunctions(baseDir, serviceName, serviceDefinition) {
...
async function deployService(baseDir, serviceName, serviceDefinition) {
  ...
  await deployFunctions(baseDir, serviceName, serviceDefinition);
}
