...
async function makeService({
  ...
  if (nasConfig) {
    if (_.isEqual(nasConfig, 'Auto')) {
      ...
      const mountPointDomain = await nas.createDefaultNasIfNotExist(vpcId, vswitchId);
