    ...
    try {
      ...
      if (ex.code === 'AccessDenied') {
        ...
        if (ex.message.indexOf('the caller is not authorized to perform') !== -1) {
          ...
          console.log(red(`You have not given sub-account permission to manage the fc service or you have not opened the fc console, the former permission link is https://ram.console.aliyun.com/users/zihanghu and the latter opening address is https://www.aliyun.com/product/fc.`));
        } else {
