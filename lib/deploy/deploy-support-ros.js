...
function mergeParameter(originParameters, parameterOverride) {
...
function parseRosParameters(parametersInTpl, parameterOverride, originParameters) {
  ...
  const mergedParameter = mergeParameter(originParameters.filter(f => !_.includes(defaultParameterKey, f.ParameterKey)), parseParameterOverride(parameterOverride));

  return transformParameters(mergedParameter.filter(f => _.includes(Object.keys(parametersInTpl), f.ParameterKey)));
}
