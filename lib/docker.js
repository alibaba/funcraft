  ...
  try {
   ...
   container = await docker.createContainer(opts);
    ...
    if (ex.message.indexOf('mount path must be absolute') !== -1) {
      ...
      throw new Error(red(`The default host machine path for docker toolbox is under 'C:\\Users', Make sure you operate in this directory.`));
