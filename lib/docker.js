...
async function checkVirtualizedEnvironment() { 
  ...
  if (obj.provider === 'virtualbox') {
    console.warn(red(`Do not support docker toolbox, please upgrade docker for windows.\nYou can download it from the official website at https://www.docker.com/. Or use the download address provided by Fun: http://mirrors.aliyun.com/docker-toolbox/windows/docker-for-windows/beta/ .`));
  }
}

async function run(opts, event, outputStream, errorStream) {

  await checkVirtualizedEnvironment();
