...
async function pullImage(imageName) {
  ...
  return new Promise((resolve, reject) => {
    debug(`begin pullling image ${imageName}, you can also use ` + yellow(`'docker pull ${imageName}'`) + ' to pull image');
...
async function startSboxContainer({
  ...
  if (isInteractive) {
    ...
    process.stdin.resume().unpipe(stream);
...
module.exports = {
  ...
  conventInstallTargetsToMounts, startSboxContainer
};