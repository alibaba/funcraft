...
async function generatePasswdMount() {
...
async function startInstallationContainer({ runtime, imageName, codeUri, targets, context }) {
  ...
  const passwdMount = await generatePasswdMount();
...
module.exports = {
  ...
  renameContainer, detectDockerVersion, resolveNasYmlToMount, generatePasswdMount
};