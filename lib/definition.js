...
function findFunctionByServiceAndFunctionName(resources, serviceName, functionName) {
  ...
  return [serviceName, serviceDefinition, functionName, functionDefinition];
}
...
function findFunctionByFunctionName(resources, functionName) {
  ...
  for (let {serviceName, serviceRes} of findServices(resources)) {
    ...
    if (functionDefinition) { return [serviceName, serviceRes, functionName, functionDefinition]; }
  }
...
module.exports = {
  findFunctionInTpl, findHttpTriggersInTpl, findFunctionsInTpl, findNasConfigInService
};