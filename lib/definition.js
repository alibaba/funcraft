...
async function matchingFuntionUnderServiceBySourceName(sourceName, resources) {
  ...
  if (obj.length > 1) {
    ...
    return findCertainFunctionByServiceAndFunctionName(resources, _.first(array), _.last(array));
  }
...
function findCertainFunctionByServiceAndFunctionName(resources, certainServiceName, certainFunctionName) {
...
module.exports = {
  ...
  findCertainFunctionByServiceAndFunctionName
};