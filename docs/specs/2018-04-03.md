...
TracingConfig | [Tracing configuration object](#tracing-configuration-object) | Tracking integration.The optional values ​​are: Enable, Disable.
...
Runtime | `string` | **Required.** The runtime environment. The optional values ​​are: nodejs6, nodejs8, nodejs10, nodejs12, python2.7, python3, java8, java11, php7.2, dotnetcore2.1, custom, custom-container.
...
InstanceType | `string` | Function instance type.The optional values ​​are: e1, c1。 
CAPort | `integer` | Listening port.
CustomContainerConfig | [Custom container configuration](#custom-container-configuration) | Define reference container.
AsyncConfiguration | [Asynchronous call configuration](#asynchronous-call-configuration) | Asynchronous call.
...
The optional values ​​are: Image、Command、Args.
...
The optional values ​​are: Destination、MaxAsyncEventAgeInSeconds、MaxAsyncRetryAttempts.
