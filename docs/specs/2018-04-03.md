...
` Protocol` is an example of `HTTP`:
```yaml
abc.com: # domain name
...
```
` Protocol` is an example of `HTTP,HTTPS`:
```yaml
abc.com: # domain name
     Type: 'Aliyun::Serverless::CustomDomain'
     Properties:
       ...
       CertConfig:
        CertName: 'CertName'
        PrivateKey: './super/privateKey.pem'
        Certificate: './super/certificate.pem'
       RouteConfig:
         routes: 
           '/a':
             ServiceName: serviceA
...
CertConfig:
  CertName: 'CertName'
  PrivateKey: './super/privateKey.pem' # Direct posting of PrivateKey content, type string, is also supported
  Certificate: './super/certificate.pem' # Direct posting of certificate content, type string, is also supported
