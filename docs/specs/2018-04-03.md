...
key | `object` | **Optional.** Indicates the key supported by the filter. This attribute contains the following attributes:
prefix | `string` | **Optional.** Matches the prefix.
suffix | `string` | **Optional.** Matches the suffix.
