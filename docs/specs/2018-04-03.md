...
PublishVersion | `boolean` | Publish a new version of this service if this field is true.

###### Example: Publish new version for existing service
...
MyService: # service name
    ...
    Properties:
      PublishVersion: true
      Description: Publish a new version for MyService
```
...
###### Aliyun::Serverless::Alias

Creates an alias for existing FC service version.

###### Properties

Property Name | Type | Description
---|:---:|---
ServiceName | `string` | **Required.** Service name which the alias belongs to.
VersionID | `string` | **Required.** Version id referred by the alias.
Description | `string` | Description of the alias.
AdditionalVersionWeight | [Additional version weight](#additional-version-weight) | Additional version with traffic shifting weight.

###### Example: Aliyun::Serverless::Alias

```yaml
MyAlias: # alias name
    Type: 'Aliyun::Serverless::Alias'
    Properties:
