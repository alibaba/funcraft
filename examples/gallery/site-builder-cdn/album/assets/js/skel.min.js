...
var skel = function () {
    ...
    var t = {
        ...
        trigger: function (e) {
            return t.events[e] && 0 != t.events[e].length ? (t.iterate(t.events[e],
                function (n) {
                    t.events[e][n]()
                }), t) : void 0
        },
        ...
        getStateId: function () {
            var e = "";
            return t.iterate(t.obj.breakpoints,
                function (n) {
            ...
            document.addEventListener ? !
                ...
                window.matchMedia ? t.matchesMedia = function (t) {
                    ...
                    var e, n, i, a, r = {
                        ...
                        o = !1;
                    for (i = t.split(/\s+and\s+/), e = 0; e < i.length; e++) n = i[e],
                        "(" == n.charAt(0) && (n = n.substring(1, n.length - 1), a = n.split(/:\s+/), 2 == a.length && (r[a[0].replace(/^\s+|\s+$/g, "")] = parseInt(a[1]), o = !0));
                    if (!o) return !1;
