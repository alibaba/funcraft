...
(function (t, e) {
    ...
    if (!i.TweenLite) {
        var s, n, r, a, o, l = function (t) {
            ...
            c = function (s, n, r, a) {
                ...
                this.check = function (h) {
                    for (var _, u, f, m, d = n.length,
                        v = d; --d > -1;)(_ = p[n[d]] || new c(n[d], [])).gsClass ? (o[d] = _.gsClass, v--) : h && _.sc.push(this);
        ...
        r = b.prototype,
            r.addEventListener = function (t, e, i, s, n) {
                ...
                var r, l, h = this._listeners[t],
                    _ = 0;
                for (null == h && (this._listeners[t] = h = []), l = h.length; --l > -1;) r = h[l],
        ...
        var k = t.requestAnimationFrame,
            ...
            x = S();
        for (s = ["ms", "moz", "webkit", "o"], n = s.length; --n > -1 && !k;) k = t[s[n] + "RequestAnimationFrame"],
                ...
                var i, s, n, r, l, h = this,
                    ...
                    d = function (t) {
                        ...
                        o > p && (u += o - c),
                            ...
                            h.time = (x - u) / 1e3,
                            e = h.time - l,
                            (!i || e > 0 || t === !0) && (h.frame++ , l += e + (e >= r ? .004 : r - e), a = !0),
                            t !== !0 && (n = s(d)),
        ...
        var I = v("TweenLite",
            function (e, i, s) {
                ...
                if (this._overwrite = l = null == l ? Q[I.defaultOverwrite] : "number" == typeof l ? l >> 0 : Q[l], (o || e instanceof Array || e.push && m(e)) && "number" != typeof e[0]) for (this._targets = a = u(e), this._propLookup = [], this._siblings = [], n = 0; a.length > n; n++) r = a[n],
        ...
        r._init = function () {
            ...
            r.render = function (t, e, i) {
                ...
                if (t >= l) this._totalTime = this._time = l,
                    ...
                    var u = t / l,
                        f = this._easeType,
                        m = this._easePower; (1 === f || 3 === f && u >= .5) && (u = 1 - u),
                            3 === f && (u *= 2),
        ...
        if (r = J.prototype, J.version = "1.10.1", J.API = 2, r._firstPT = null, r._addTween = function (t, e, i, s, n, r) {
            ...
            I._onPluginEvent = function (t, e) {
                ...
                if ("_onInitAllProps" === t) {
                    for (; o;) {
                        for (a = o._next, s = n; s && s.pr > o.pr;) s = s._next; (o._prev = s ? s._prev : r) ? o._prev._next = o : n = o,
